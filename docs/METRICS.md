...
|---|---|---|---|
| Bat-to-ball | `Contact%` | `Whiff%` | all |
| Swing decision | `Chase%↓` | `Chase%` | Triple-A |
| Damage | `HR/FB` | `HR/FB↓` | all |
| Contact quality | `EV` | `EV↓` | Triple-A |
| Ball in the air | `Air%` | `GB%` | all |
| Direction | `Pull%` | `Pull%↓` | all |
| Plate discipline | `BB%` | `BB%↓` | all |
